...
- [x] 1.0 Harden FIX lifecycle and sequence recovery
  ...
  - [x] 1.11 Run `/pre-push-review`.
  - [x] 1.12 Smoke test category: `NO_SERVER_SURFACE` for this parent task.

- [x] 2.0 Add TrueX book data contract and ALO marketability safety
  ...
  - [x] 2.7 Run `/adversarial-reviewer`, `/pre-push-review`, and mark smoke category `NO_SERVER_SURFACE`.

- [x] 3.0 Implement passive-safe replacement state
  ...
  - [x] 3.8 Run `/adversarial-reviewer`, `/pre-push-review`, and mark smoke category `NO_SERVER_SURFACE`.

- [x] 4.0 Add fee-aware optional taking and liquidity-role metadata
  ...
  - [x] 4.8 Run `/adversarial-reviewer`, `/pre-push-review`, and mark smoke category `NO_SERVER_SURFACE`.
...
- [ ] 5.0 Document, review, PR, and merge
  ...
  - [x] 5.4 Run `/pre-push-review`.
  - [x] 5.5 Smoke test with paper/UAT mode if credentials/environment are available; otherwise record `SMOKE_MISSING` or `NO_SERVER_SURFACE` with rationale.
  - [x] 5.6 Commit on the feature branch.
