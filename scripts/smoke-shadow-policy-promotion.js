...
const report = buildShadowPromotionReport({
  ...
  candidates: [{ id: 'candidate', policy }], evaluator: { split: { trainEnd: 100, validationStart: 100, validationEnd: 1000 }, referencePrices: [{ timestamp: 60120, price: 101 }, { timestamp: 300120, price: 101 }, { timestamp: 3600120, price: 101 }] }, criteria: { minObservationEvents: 2, maxInventoryRangeBTC: 1 },
});
